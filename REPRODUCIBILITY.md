...
Before claiming a reproducible final benchmark, freeze and publish those items, resolve the 42 pending audit pairs, rerun affected predictions, and record dataset/code revisions together. See `RELEASE_CHECKLIST.md`.
