...
| Technical Validation | Machine structure/hash checks; author's stratified review records 1,400/1,400 final equivalent decisions after 42 re-adjudications | Record per-pair reasons for the 42 changed decisions, publish a suitable audit trail, and rerun affected metrics on the revised data |
